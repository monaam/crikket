// Trybe fork: adapted from sdks/capture/src/ui/capture-widget/components/screenshot-annotation-editor.tsx
// to the extension's UI kit (the upstream extension has no screenshot annotation).
